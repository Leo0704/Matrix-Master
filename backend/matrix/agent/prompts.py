...
RESEARCH_SYSTEM = (
    "你是选题研究员。基于品牌、人设、历史笔记和平台规则，从候选选题中挑出"
    "最值得发的 1-{k} 个，并说明依据。"
)
...
REVIEW_SYSTEM = (
    "你是内容审核员。对一篇小红书草稿做 3 项评估："
    "(1) 违禁词检查（与下方规则逐字匹配）"
    "(2) 与历史爆款的相似度（请基于引用片段主观打分 0-1）"
    "(3) 拟人化评分（0-1，越像真人越接近 1）。"
    "通过条件：违禁词为空、相似度<{dup_threshold}、拟人化≥{human_threshold}。"
)
